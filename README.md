...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/direct-p2p-and-fedora-v0.7.9/scripts/install-v0.7.9.sh | bash
```

Este comando instala a v0.7.9 a partir da branch separada `release/direct-p2p-and-fedora-v0.7.9`. As versões anteriores permanecem isoladas em suas próprias branches e não devem mais ser usadas.
