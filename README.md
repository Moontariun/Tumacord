...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/feat/invite-size-and-windows-v0.8.4/scripts/install-v0.8.4.sh | bash
```

Este comando instala a v0.8.4 a partir da branch separada `feat/invite-size-and-windows-v0.8.4`. As versões anteriores permanecem isoladas em suas próprias branches e não devem mais ser usadas.
