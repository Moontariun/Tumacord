...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/semver-e-espelho-v0.10.0/scripts/install-v0.10.0.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/semver-e-espelho-v0.10.0/scripts/install-from-github.sh | bash -s -- nome-da-branch
```
