...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/graphics-and-capture-v0.8.9/scripts/install-v0.8.9.sh | bash
```

Este comando instala a v0.8.9 a partir da branch separada `release/graphics-and-capture-v0.8.9`. As versões anteriores permanecem isoladas em suas próprias branches e não devem mais ser usadas.
