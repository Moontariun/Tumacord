...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/lives-e-permissoes-v0.13.5/scripts/install-v0.13.5.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/lives-e-permissoes-v0.13.5/scripts/install-from-github.sh | bash -s -- nome-da-branch
```
