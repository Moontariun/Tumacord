...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/invite-stability-v0.7.10/scripts/install-v0.7.10.sh | bash
```

Este comando instala a v0.7.10 a partir da branch separada `release/invite-stability-v0.7.10`. As versões anteriores permanecem isoladas em suas próprias branches e não devem mais ser usadas.
