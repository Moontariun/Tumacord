...
- ao clicar em **Transmitir tela**, o seletor já pede a fonte, a qualidade e se a live deve ou não ter áudio;
...
O arquivo `docker-compose.yml` publica a porta TCP `4600`, reinicia o contêiner automaticamente e mantém contas, perfis, mensagens e anexos no volume `tumacord-data`. Para acompanhar:
