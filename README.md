...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/origem-embutida-v0.12.2/scripts/install-v0.12.2.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/origem-embutida-v0.12.2/scripts/install-from-github.sh | bash -s -- nome-da-branch
```
