...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/ui-stability-and-invite-v0.8.5/scripts/install-v0.8.5.sh | bash
```

Este comando instala a v0.8.5 a partir da branch separada `release/ui-stability-and-invite-v0.8.5`. As versões anteriores permanecem isoladas em suas próprias branches e não devem mais ser usadas.
