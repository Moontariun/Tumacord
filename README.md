...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/ping-e-reversao-v0.13.4/scripts/install-v0.13.4.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Moontariun/Tumacord/release/ping-e-reversao-v0.13.4/scripts/install-from-github.sh | bash -s -- nome-da-branch
```
